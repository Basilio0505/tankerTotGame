...
export default class LevelSelect extends Phaser.Scene {
  ...
  create (data) {
    ...
    var start2 = this.add.sprite(this.centerX+150,this.centerY-180,'start',0).setInteractive().setScale(5);
    ...
    var start3 = this.add.sprite(this.centerX-150,this.centerY-90,'start',0).setInteractive().setScale(5);
    ...
    var back = this.add.sprite(this.centerX,this.centerY+180,'start',0).setInteractive().setScale(5);
    back.on("pointerover", function(){this.setFrame(1);});
    back.on("pointerout", function(){this.setFrame(0);});
    back.on("pointerup", function(){this.scene.start("Level1")}, this);
