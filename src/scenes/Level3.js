...
export default class Level3 extends Phaser.Scene {
  ...
  create (data) {
    ...
    //create player
    this.player = this.matter.add.image(138, 536, 'tankertot', null, {friction:0}).setFixedRotation(true).setCollisionCategory(this.playerCategory);
    this.cannon = this.matter.add.image(138, 540, 'cannon', null, {friction:0, shape: 'circle'}).setCollisionCategory(this.playerCategory).setScale(.78);
