...
export default class Level3 extends Phaser.Scene {
  ...
  create (data) {
    ...
    //create player
    this.player = this.matter.add.image(138, 530, 'tankertot', null, {friction:0}).setFixedRotation(true).setCollisionCategory(this.playerCategory);
    this.cannon = this.matter.add.image(138, 530, 'cannon', null, {friction:0, shape: 'circle'}).setCollisionCategory(this.playerCategory).setScale(.84);
    ...
    var plat5 = this.matter.add.image(this.centerX, 455, "woodPlatform", null, { isStatic: true, friction: 0 }).setScale(3).setCollisionCategory(this.environmentCategory);
