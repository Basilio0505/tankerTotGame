...
export default class Level6 extends Phaser.Scene {
  ...
  create (data) {
    ...
    //create platforms
    var plat1 = this.matter.add.image(98, 200, "woodPlatform", null, { isStatic: true, friction: 0 , restitution: 1 }).setScale(1.5).setCollisionCategory(this.environmentCategory);
